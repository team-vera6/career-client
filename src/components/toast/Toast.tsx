...
const Toast = ({ id, message, iconType }: ToastProps) => {
  ...
  return (
    <div
      id={String(id)}
      role="alert"
      className={`mx-auto min-w-[24.125rem] max-w-[36.625rem] h-12 bg-surface-alternative text-text-invert font-body-16 flex items-center px-4 gap-2 rounded-lg duration-300 ease-out ${
